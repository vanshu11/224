...
def Bike_control():
	dropped_vehicle.apply_control(carla.VehiclesControl(throttle=0.53))
	time.sleep(15)
	dropped_vehicle.apply_control(carla.VehiclesControl(hand_brake=True))
	dropped_vehicle.apply_control(carla.VehiclesControl(throttle=0.3,steer=-0.38))
	dropped_vehicle.set_light_state(carla.VehicleLightState(carla.VehicleLightState.LeftBlinker|carla.VehicleLightState.HighBeam|carla.VehicleLightState.Brake))
	time.sleep(2)
	dropped_vehicle.apply_control(carla.VehiclesControl(throttle=0.31))
	dropped_vehicle.set_light_state(carla.VehicleLightState(carla.VehicleLightState.LeftBlinker|carla.VehicleLightState.HighBeam|carla.VehicleLightState.Brake))
	time.sleep(3)
	dropped_vehicle.apply_control(carla.VehiclesControl(hand_brake=True))
